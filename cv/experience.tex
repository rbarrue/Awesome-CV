...
\begin{cventries}
    ...
    {Oct. 2018 - PRESENT}
    {
        ...
        \begin{cvitems}
            ...
            \item {contributed to the combined measurement of Higgs boson decays to bottom and charm quarks in VH production: calculated priors for shape modelling uncertainties of the W+jets background in the high-momentum regime using neural-network-based high-dimensional reweighting to mitigate statistical fluctuations, defined the correlation scheme for various shape and acceptance uncertainties of the W+jets and Z+jets backgrounds. Currently in ATLAS approval (internal note: \href{https://cds.cern.ch/record/2743096}{ATL-COM-PHYS-2020-765}).}
