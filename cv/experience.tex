...
\begin{cventries}
    ...
    {Apr. 2020 - PRESENT}
    {
        ...
        \begin{cvitems}      
            \item {studied the feasibility of searching for CP violating phenomena from the ATLAS analysis measuring the cross-section of WH production at very high W boson transverse momenta (to which I contributed as a member of the ATLAS Collaboration).}
        \end{cvitems}
    }
