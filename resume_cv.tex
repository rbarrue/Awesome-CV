...
\documentclass[11pt, a4paper,draft]{awesome-cv} % A4 paper size by default, use 'letterpaper' for US letter
...
\position{PhD researcher} % Your expertise/fields
% \quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{Ricardo Barrué ~~~·~~~ CV}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
