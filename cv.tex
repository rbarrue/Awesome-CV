...
\name{Ricardo}{Barrué}
\position{PhD researcher at {Laboratório de Instrumentação e Física Experimental de Partículas (LIP)} and {Instituto Superior Técnico (IST)}}
...
% \input{cv/trainings_secondary.tex}
\input{cv/publications.tex}
\input{cv/talks.tex}
\input{cv/supervision.tex}
% \input{cv/supervision_secondary.tex}
\input{cv/experience.tex}
% \input{cv/experience_secondary.tex}
\input{cv/other_activities.tex}
\input{cv/skills.tex}
\input{cv/committees.tex}
\input{cv/outreach.tex}
% \input{cv/outreach_secondary.tex}
